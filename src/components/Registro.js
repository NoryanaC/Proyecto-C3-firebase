...
const[categoria, setCategoria]=React.useState('')
  ...
  return (
    <div className='container div-inicio p-3 mb-5 bg-body h-100'>
      <div className='row justify-content-left w-50 p-3 border border-dark '>
        <div >
          <h2 className='display-6 text-center mb-4 p-3 mb-2 bg-secondary text-white'>
        ...
        <div className='d-grid gap-2'>
          {
            modEdicion ? (<button className='btn btn-outline-dark'
      ...
      <div className='row mt-5 mb-5 border border-dark p-3'>
          <h2 className='display-6 p-3 mb-2 bg-secondary text-white text-center'> Vista de solicitudes</h2>
                  ...
                  <div className="card col-5 shadow-sm bg-body"  key={elemento.id}>
                    ...
                    <div className="list-group list-group-flush">
                      ...
                      <div className="list-group-item d-flex gap-2 justify-content-center">
                          <button onClick={()=>eliminarDato(elemento.id)} className='btn btn-outline-danger  mx-2'>Eliminar</button>
                          <button onClick={()=>editarDatos(elemento)} className='btn btn-outline-dark  mx-2'>Editar</button>
                      </div>
                    </div>
